...
def initUsers():
    ...
    u9 = User(name='Thor', uid='90028', breed='Retriever Blend', sex= "male", dob=date(2020, 8, 17), price='$200', score=1)
    ...
    u21 = User(name='Carl', uid='98230', breed='Australian Terrier', sex= "male", dob=date(2019, 2, 21), price='$190', score=22.5)    
